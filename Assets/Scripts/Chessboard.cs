...
public class Chessboard : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (Physics.Raycast(ray, out info, 100, LayerMask.GetMask("Tile", "Hover", "Highlight")))
        {
            ...
            //if hovering after not hovering 
            ...
            //if already hovering, change the previous one
            ...
            if (Input.GetMouseButtonDown(0))
            {
                if (chessPieces[hitPosition.x, hitPosition.y] != null)
                {
                    ...
                    if ((chessPieces[hitPosition.x, hitPosition.y].team == 0 && isWhiteTurn && currentTeam == 0) || (chessPieces[hitPosition.x, hitPosition.y].team == 1 && !isWhiteTurn && currentTeam == 1))
                    {
                        ...
                        //get a list of possible moves, and highlight the tiles 
        ...
        //visual aid on what piece is being dragged
    ...
    private void MoveTo(int originalX, int originalY, int x, int y)
    {
        ...
        //is there another piece where we are going 
        if (chessPieces[x, y] != null)
        {
    ...
    {
        //client has connected - assign team and retirn ,essage
        ...
        //return to client 
        Server.Instance.SentToClient(cnn, nw);
    ...
    {
        //recieve message and broadcast back
        NetMakeMove mm = msg as NetMakeMove;

        //validation check

        //recieve and broadcast
